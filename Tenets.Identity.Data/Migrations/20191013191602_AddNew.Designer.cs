...
namespace Tenets.Identity.Data.Migrations
{
    ...
    [Migration("20191013191602_AddNew")]
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 10, 13, 21, 16, 2, 69, DateTimeKind.Local).AddTicks(7721),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 10, 13, 21, 16, 2, 69, DateTimeKind.Local).AddTicks(8424),
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 10, 13, 21, 16, 2, 69, DateTimeKind.Local).AddTicks(8443),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@A3n.com",
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 10, 13, 21, 16, 2, 61, DateTimeKind.Local).AddTicks(4389),
                            Password = "AEI8Ml0NjJs46HCP9CY1mdsIdA1iP801Fa6W+qQ92MwFGglE70UxZKxkv7QrWyboMA==",
                            PhoneNumber = "+9",
