...
namespace Tenets.Identity.Data.Migrations
{
    ...
    [Migration("20191229215546_AddRepresentativeid")]
    partial class AddRepresentativeid
    {
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 12, 29, 23, 55, 46, 202, DateTimeKind.Local).AddTicks(8274),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 12, 29, 23, 55, 46, 202, DateTimeKind.Local).AddTicks(8741),
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 12, 29, 23, 55, 46, 202, DateTimeKind.Local).AddTicks(8758),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@A3n.com",
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 12, 29, 23, 55, 46, 167, DateTimeKind.Local).AddTicks(6873),
                            Password = "AIwitjOH76yImoxOIAjZwuzbGZopN6pdJIg1SzAFkKym5PAomRqO23QQlJepzzZVSg==",
                            PhoneNumber = "+9",
