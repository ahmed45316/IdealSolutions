...
namespace Tenets.Identity.Data.Migrations
{
    ...
    [Migration("20190720180912_CreateDB")]
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsStop = false,
                            ItsOrder = 1,
                            LastAccessed = new DateTime(2019, 7, 20, 20, 9, 11, 701, DateTimeKind.Local).AddTicks(1853),
                        ...
                        new
                        {
                            ...
                            IsStop = false,
                            ItsOrder = 2,
                            LastAccessed = new DateTime(2019, 7, 20, 20, 9, 11, 701, DateTimeKind.Local).AddTicks(5960),
                        ...
                        new
                        {
                            ...
                            IsStop = false,
                            ItsOrder = 7,
                            LastAccessed = new DateTime(2019, 7, 20, 20, 9, 11, 701, DateTimeKind.Local).AddTicks(5999),
                        ...
                        new
                        {
                            ...
                            IsStop = false,
                            ItsOrder = 8,
                            LastAccessed = new DateTime(2019, 7, 20, 20, 9, 11, 701, DateTimeKind.Local).AddTicks(6831),
                            ParentId = new Guid("c12c91c0-5c2f-45cc-ab6d-1d256538a5ee"),
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 7, 20, 20, 9, 11, 699, DateTimeKind.Local).AddTicks(5858),
                            Name = "Administrator"
                        });
                });
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 7, 20, 20, 9, 11, 697, DateTimeKind.Local).AddTicks(3983),
                            LockoutEnabled = false,
                            PasswordHash = "ALQ9yNzGkKdXRP8gdol1whMNSIZAlmjXpF6SNHELSKf0N6+aZs24+5h8B4OzpBWrIw==",
                            PhoneNumber = "+9",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "045a1c70-35b0-4d51-b5e7-5a88beb747a7",
            ...
            modelBuilder.Entity("Tenets.Identity.Entities.UsersRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastAccessed = new DateTime(2019, 7, 20, 20, 9, 11, 700, DateTimeKind.Local).AddTicks(1450),
