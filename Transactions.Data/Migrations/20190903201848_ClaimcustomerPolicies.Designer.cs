...
namespace Transactions.Data.Migrations
{
    ...
    [Migration("20190903201848_ClaimcustomerPolicies")]
    partial class ClaimcustomerPolicies
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transactions.Entities.Entites.ClaimCustomerPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("ClaimCustomerId");
                    ...
                    b.HasIndex("ClaimCustomerId");

                    b.HasIndex("PolicyDetailId");

                    b.ToTable("ClaimCustomerPolicies");
                });
            ...
            modelBuilder.Entity("Transactions.Entities.Entites.ClaimCustomerPolicy", b =>
                {
                    b.HasOne("Transactions.Entities.Entites.ClaimCustomer", "ClaimCustomer")
                        .WithMany("ClaimCustomerPolicies")
                        .HasForeignKey("ClaimCustomerId")
