...
namespace Codes.API.Controllers
{
    ...
    public class CityController : BaseController,IMainEndPoint<CityDto>
    {
        ...
        public async Task<IResult> Add(CityDto model)
        {
            ...
            return await _cityServices.AddAsync(model);
        }
        /// <summary>
        /// Get data by Id
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IDataPagging> GetPaged([FromBody]BaseParam<CityFilter> filter)
        {
        ...
        public async Task<IResult> Update(CityDto model)
        {
            ...
            return await _cityServices.UpdateAsync(model);
        }
    }
}